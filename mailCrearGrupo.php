<?php
	...
	$message = "<table border='1' bordercolor='black' border-collapse:'collapse'>
			...
			<tr align='left'>
				...
				<td style='font-family: Arial;'>
					<br>Te han invitado a unirte a su grupo.<br>
				</td>
				<td style='width:10%;'></td>
			</tr>
			<tr align='left'>
				<td style='width:10%;'></td>
				<td style='font-family: Arial;'>
					<br>Ingresá a www.prodefutbolero.com.ar, registrate y comenzá a jugar.<br><br>
				</td>
				<td style='width:10%;'></td>
			</tr>
	...
	$mail->Host = "localhost"; 
	$mail->From = "edu_sanchez77@hotmail.com;"//$email_usuario; 
	$mail->FromName = "Eduardo Sánchez"//$nombre_usuario." ".$apellido_usuario; 
