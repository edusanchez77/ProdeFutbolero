<?php
	...
	$query = "INSERT INTO grupos VALUES ('','".$dni."','".strtoupper($nombre)."','".$premio."','Y')";
	$result = mysqli_query ($conexion, $query);

	$query_grupo = "SELECT gru_id FROM grupos WHERE gru_nombre = '$nombre'";
	$result_grupo = mysqli_query($conexion, $query_grupo);
	$fila_grupo = mysqli_fetch_row($result_grupo);
	$id_grupos = $fila_grupo[0];
	...
	echo "<meta http-equiv='refresh' content='1;url=http://www.prodefutbolero.com.ar/grupo.php?id=0'>";
