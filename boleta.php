<?php
    ...
    $inactivo = 180;//20min en este caso.
...
<body>
	...
	<section id="main">
		...
		<section id="contenido">
			...
			<div id="partidos">
				<form method="post" action="pronostico.php?grupo=<?php echo $grupo ?>">
					<div id="fecha">
						<p>FECHA 1</p>
					</div>
					<?php
						...
						//echo $fechasistema;
						//Obtengo Partido
						$query = "SELECT pa_dia, pa_eq_local, pa_eq_visitante, pa_sede, pa_nro_fecha, pa_id FROM partidos WHERE pa_eq_grupo = '$grupo' and pa_nro_fecha = '1'";
					...
					<?php
						//Obtengo Partido
						$query = "SELECT pa_dia, pa_eq_local, pa_eq_visitante, pa_sede, pa_nro_fecha, pa_id FROM partidos WHERE pa_eq_grupo = '$grupo' and pa_nro_fecha = '2'";
						$result = mysqli_query ($conexion, $query);
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local3" value="<?php if(isset($_SESSION['dni'])){if($pronostico3[2]==$partido3[5]){echo $pronostico3[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local4" value="<?php if(isset($_SESSION['dni'])){if($pronostico4[2]==$partido4[5]){echo $pronostico4[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
					...
					<?php
						//Obtengo Partido
						$query = "SELECT pa_dia, pa_eq_local, pa_eq_visitante, pa_sede, pa_nro_fecha, pa_id FROM partidos WHERE pa_eq_grupo = '$grupo' and pa_nro_fecha = '3'";
						$result = mysqli_query ($conexion, $query);
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local5" value="<?php if(isset($_SESSION['dni'])){if($pronostico5[2]==$partido5[5]){echo $pronostico5[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local6" value="<?php if(isset($_SESSION['dni'])){if($pronostico6[2]==$partido6[5]){echo $pronostico6[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
