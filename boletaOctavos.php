...
<body>
	...
	<section id="main">
		...
		<section id="contenido">
			...
			<div id="partidos">
				<form method="post" action="pronostico.php?grupo=8">
					<div id="fecha">
						<p><br></p>
					</div>
					<?php
					...
					<?php
                        ...
                        $fechapartido = strtotime($partido5[0]);
						//Obtengo Bandera
						...
						//Obtengo Pronosticos
						if(isset($_SESSION['dni'])){
							$query1 = "SELECT pro_local, pro_visitante, pro_pa_id FROM pronosticos WHERE pro_usr_dni = '$dni' and pro_pa_id = '$partido5[5]'";
							$result1 = mysqli_query ($conexion, $query1);
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local5" value="<?php if(isset($dni)){if($pronostico5[2]==$partido5[5]){echo $pronostico5[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
						<div id="visitante"><input type="text" onkeypress="return valida(event)" name="visitante5" value="<?php if(isset($_SESSION['dni'])){if($pronostico5[2]==$partido5[5]){echo $pronostico5[1];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						...
						<input type=hidden name="fecha5" value="<?php echo $fechapartido ?>">
					</div>
					...
					<?php
                        ...
                        $fechapartido = strtotime($partido6[0]);
						//Obtengo Bandera
						...
						//Obtengo Pronosticos
						if(isset($_SESSION['dni'])){
							$query1 = "SELECT pro_local, pro_visitante, pro_pa_id FROM pronosticos WHERE pro_usr_dni = '$dni' and pro_pa_id = '$partido6[5]'";
							$result1 = mysqli_query ($conexion, $query1);
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local6" value="<?php if(isset($dni)){if($pronostico6[2]==$partido6[5]){echo $pronostico6[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
						<div id="visitante"><input type="text" onkeypress="return valida(event)" name="visitante6" value="<?php if(isset($_SESSION['dni'])){if($pronostico6[2]==$partido6[5]){echo $pronostico6[1];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						...
						<input type=hidden name="fecha6" value="<?php echo $fechapartido ?>">
					</div>
					...
					<?php
                        ...
                        $fechapartido = strtotime($partido7[0]);
						//Obtengo Bandera
						...
						//Obtengo Pronosticos
						if(isset($_SESSION['dni'])){
							$query1 = "SELECT pro_local, pro_visitante, pro_pa_id FROM pronosticos WHERE pro_usr_dni = '$dni' and pro_pa_id = '$partido7[5]'";
							$result1 = mysqli_query ($conexion, $query1);
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local7" value="<?php if(isset($dni)){if($pronostico7[2]==$partido7[5]){echo $pronostico7[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
						<div id="visitante"><input type="text" onkeypress="return valida(event)" name="visitante7" value="<?php if(isset($_SESSION['dni'])){if($pronostico7[2]==$partido7[5]){echo $pronostico7[1];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						...
						<input type=hidden name="fecha7" value="<?php echo $fechapartido ?>">
					</div>
					...
					<?php
                        ...
                        $fechapartido = strtotime($partido8[0]);
						//Obtengo Bandera
						...
						//Obtengo Pronosticos
						if(isset($_SESSION['dni'])){
							$query1 = "SELECT pro_local, pro_visitante, pro_pa_id FROM pronosticos WHERE pro_usr_dni = '$dni' and pro_pa_id = '$partido8[5]'";
							$result1 = mysqli_query ($conexion, $query1);
					...
					<div id="partido">
						...
						<div id="local"><input type="text" onkeypress="return valida(event)" name="local8" value="<?php if(isset($dni)){if($pronostico8[2]==$partido8[5]){echo $pronostico8[0];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						<div id="separador">-</div>
						<div id="visitante"><input type="text" onkeypress="return valida(event)" name="visitante8" value="<?php if(isset($_SESSION['dni'])){if($pronostico8[2]==$partido8[5]){echo $pronostico8[1];}}?>" <?php if($fechasistema >= $fechapartido){ ?> disabled style="opacity:.3" <?php } ?>/></div>
						...
						<input type=hidden name="fecha8" value="<?php echo $fechapartido ?>">
					</div>
