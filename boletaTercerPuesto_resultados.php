...
<body>
	...
	<section id="main">
		...
		<section id="contenido">
			...
			<div id="partidos">
				<form method="post" action="insertarResultados.php?grupo=3">
					<div id="fecha">
						<p><br></p>
					</div>
					<?php
						...
						//echo $fechasistema;
						//Obtengo Partido
						$query = "SELECT pa_dia, pa_eq_local, pa_eq_visitante, pa_sede, pa_nro_fecha, pa_id FROM partidos WHERE pa_eq_grupo = '3' and pa_nro_fecha = '1'";
