...
<body>
	...
	<header>
					...
					<li class="dropdown">
						<?php
							if(isset($_SESSION['usuario'])){
								...
								?>
									<a href="#"><p>Iniciar Sesion<br><b>Mi Cuenta</b></p></a>
									<ul class="sub-menu">
										<li id="sesion" class="sesion"><a href="#modal"><b>Iniciar sesión</b></a></li>
										<li id="registro" class="registro"><a href="#">¿Sos nuevo? <font>Registrate</font></a></li>
									</ul>
								<?php
							}
						?>
		...
		<?php
			if(!isset($_SESSION['usuario'])){
		?>
			<section id="modal" class="modal fade animate" style="display: none;">
	    		<div class="modal-body">
	    			<h2>Ingresá a Mi Cuenta</h2>
	    			
	    			<form method="post" action="login.php">
	    			<input type="submit" name="" value="Ingresar con Facebook">
	    				<div class="gb-login-divider">
	    					<span>o con tu dni</span>
	    				</div>
						<div class="inputBox"> 
	    			...
	    			<input type="register" name="" value="Registrate con tu E-mail" class="register">
	    		</div>
	    	</section>

	    	<section id="modal1" class="modal fade animate" style="display: none;">
	    		<div class="modal1-body">
	    			<h2>Registrate | <font>¿Ya tenés cuenta? <a href="#" class="login">Ingresá</a></font></h2>
	    			
	    			<form method="post" action="registro.php" onsubmit="return valida(this)">
						<div class="inputBox"> 
							<input type="text" name="dni" required=""> 
							<label>DNI</label> 
						</div> 
						...
						<div class="inputBox" id="fecha"> 
							<input type="date" name="cumpleanios" step="1" min="1900-01-01" max="2013-12-31">
	...
	<section id="wrap">
		<section id="main">
			...
			<section id="contenido">
				...
				<section id="playoff">
					<div id="fase"><p><a href="#">OCTAVOS DE FINAL</a></p></div>
					<div id="fase"><p><a href="#">CUARTOS DE FINAL</a></p></div>
					<div id="fase"><p><a href="#">SEMIFINAL</a></p></div>
					<div id="fase"><p><a href="#">TERCER PUESTO</a></p></div>
					<div id="fase"><p><a href="#">FINAL</a></p></div>
				</section>
			</section>
		</section>
	</section>
