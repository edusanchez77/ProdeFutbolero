	...
	?>
		...
		?>
			...
			<section id="contenido">
				<div id="grupo">
					<p>CARGAR RESULTADOS GRUPO <?php echo $grupo ?></p>
				</div>
				<div id="partidos">
					<form method="post" action="insertarResultados.php?grupo=<?php echo $grupo ?>">
						<div id="fecha">
							<p>Fecha 1</p>
						</div>
						<?php
						...
						<div id="partido">
							...
							<div id="local"><input name="local3" value="<?php if(isset($_SESSION['dni'])){if($pronostico3[2]==$partido3[5]){echo $pronostico3[0];}}?>" /></div>
							<div id="separador">-</div>
						...
						<div id="partido">
							...
							<div id="local"><input name="local4" value="<?php if(isset($_SESSION['dni'])){if($pronostico4[2]==$partido4[5]){echo $pronostico4[0];}}?>" /></div>
							<div id="separador">-</div>
						...
						<div id="partido">
							...
							<div id="local"><input name="local5" value="<?php if(isset($_SESSION['dni'])){if($pronostico5[2]==$partido5[5]){echo $pronostico5[0];}}?>" /></div>
							<div id="separador">-</div>
						...
						<div id="partido">
							...
							<div id="local"><input name="local6" value="<?php if(isset($_SESSION['dni'])){if($pronostico6[2]==$partido6[5]){echo $pronostico6[0];}}?>" /></div>
							<div id="separador">-</div>
